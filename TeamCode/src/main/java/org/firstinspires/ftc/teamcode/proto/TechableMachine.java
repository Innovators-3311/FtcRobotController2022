...
@TeleOp(name = "Teachable machine", group = "Concept")
public class TechableMachine extends LinearOpMode
{
    private static final String TFOD_MODEL_FILE  = "/sdcard/FIRST/tflitemodels/test.tflite";
